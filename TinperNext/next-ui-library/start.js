...
const errorMsg = '必需 传递一个参数owner;比如 npm run cy -- owner=***; f的取值范围是[ "gyj", "jwx", "lyy", "lxy", "mjc", "mzk", "shl", "wy", "linux"]';
const errorMsg1 = '参数owner的传入存在错误,取值范围[ "gyj", "jwx", "lyy", "lxy", "mjc", "mzk", "shl", "wy", "linux"]'

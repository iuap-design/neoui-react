 ...
 *
 * @title 竖向示例
 * @description 距离顶部距离offsetTop定位，竖向示例
 *
 */
...
class Demo0 extends Component<{dir:string}, {anthors?: {href: string, name: string, content: string}[]}> {
    constructor(props: {}) {
        super(props);
        this.state = {
            anthors: [
    ...
    render() {
	    return (
	        <div className="demo0" style={{width: '98%'}}>
	            <Anchor antd offsetTop={50} style={{width: '10%', [ this.props.dir === 'rtl' ? "marginRight" : "marginLeft"]: '90%'}}>
	                {

/**
 *
 * @title keyboard、forceRender 属性
 * @description keyboard 是否支持键盘 esc 关闭。 forceRender 预渲染 Drawer 内元素
 * @type other
 */
...
class Demo11 extends Component<{}, DrawerState11> {
    constructor(props: {}) {
        super(props);
        this.state = {
            placement: 'right',

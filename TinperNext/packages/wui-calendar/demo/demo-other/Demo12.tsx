...
class Demo12 extends Component<{}, DemoState> {
    ...
    constructor(props: DemoState, context: {}) {
        super(props, context);

        this.state = {
            type: 'date',
            selectType: '休',
            scrollIntoValue: moment('2030-04-09'),
            isEdit: false,
    ...
    onSelect = (value: Moment) => {
        this.setState({scrollIntoValue: value})
    }
	...
	saveCal = () => {
	    this.setState({
	        ...
	        // scrollIntoValue: this.state.scrollIntoValue.add(30, 'days')
	    })
	}
	    ...
	    return (
	        <div>
	            ...
	            <Calendar
	                ...
	                scrollIntoValue={this.state.scrollIntoValue}

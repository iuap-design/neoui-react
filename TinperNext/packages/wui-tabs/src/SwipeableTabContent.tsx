...
// class SwipeableTabContent extends React.Component {
...
//     const currentIndex = this.computeIndex({
...
// SwipeableTabContent.propTypes = propTypes
// SwipeableTabContent.defaultProps = defaultProps

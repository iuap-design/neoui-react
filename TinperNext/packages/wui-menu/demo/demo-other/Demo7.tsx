 ...
 * @description 子菜单在右侧呼出形式显示。支持上下左右及enter 键操作
 */

import {Input, Menu, MenuProps} from '@tinper/next-ui';
	...
	render() {
	    return (
	        <div>
	            ...
	            <Menu keyboard={true} onClick={this.handleClick} style={{width: 240}} mode="vertical">

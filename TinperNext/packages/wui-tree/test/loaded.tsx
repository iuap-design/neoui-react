 ...
 */
 ...
 class Demo5 extends Component<any, {treeData:GlobalDataType, loadedKeys: string[]}> {
     ...
     render() {
         ...
         return (
             <Tree className="myCls" loadedKeys={loadedKeys} defaultExpandedKeys={['0-1']} onLoad={(...arg) => {
                this.onLoad(...arg);
                return this.props.onLoad(...arg)

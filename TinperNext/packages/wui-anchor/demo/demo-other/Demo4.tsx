...
class Demo2 extends Component<{}, {anthors?: {href: string, name: string, content: string}[]}> {
    constructor(props: {}) {
        super(props);
        this.state = {
            anthors: [
     ...
     render() {
         return (
             <div className="demo2">
                 <Anchor antd offsetTop={150} style={{width: '10%', marginLeft: '90%'}} affix={false}
                     showInkInFixed={false} onClick={this.onClick}>
                     {

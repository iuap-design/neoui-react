...
class Demo4 extends Component<{}, {anthors?: {href: string, name: string, content: string}[]}> {
    constructor(props: {}) {
        super(props);
        this.state = {
            anthors: [
    ...
    render() {
	    return (
	        <div className="demo4" style={{width: '98%'}}>
                <div style={{height: '300px'}}>
                    <Anchor antd collapsable={true}>
                        {

...
class TreeNodeDemo extends Component {
    constructor(props) {
        super(props);
	...
	render() {
	    return (
	        <Tree
	            ...
	            defaultExpandAll
	        >
	            <TreeNode title="parent 1" key="0-0" icon={<Icon type="uf-treefolder"/>} {...this.props}>
	                <TreeNode title="parent 2" key="0-0-0" icon={<Icon type="uf-list-s-o"/>} {...this.props} />
	            </TreeNode>
	        </Tree>
	    );
	}

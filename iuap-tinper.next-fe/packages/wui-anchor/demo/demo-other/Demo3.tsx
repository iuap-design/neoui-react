...
class Demo0 extends Component<{}, {anthors?: {href: string, name: string, content: string}[]}> {
	 constructor(props: {}) {
		 super(props);
		 this.state = {
			 anthors: [
	 ...
	 onDropDownChange = (href: string) => {
	     console.log('下拉回调', href)
	 }

	 render() {
		 return (
			 <div className="demo2">
				 <Anchor antd offsetTop={250} style={{width: '600px'}} direction="horizontal" collapsable={true} onDropDownChange={this.onDropDownChange}>
					 {
				 ...
				 <div className="content">
					 {
						 this.state.anthors!.map(item => {
							 return (
								 <div className="demo-con" style={{'paddingTop': '50px'}} id={item.href}
									  key={item.href}>
									 <pre>
										 {item.content}
									 </pre>

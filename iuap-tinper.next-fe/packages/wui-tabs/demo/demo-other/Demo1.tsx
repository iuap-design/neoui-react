/**
 *  @title 多Tabs 隐藏滚动
 *  @description tab 页签超出滚动展示， moreIcon，自定义更多按钮图标（默认“...”）
 */

import {Tabs, TabsProps, Icon} from '@tinper/next-ui';
import React, {Component} from 'react';

const {TabPane} = Tabs;

interface TabsState1 {
	activeKey: string;
	testvalue: any;
}

class Demo1 extends Component<{}, TabsState1> {
	state = {
	    activeKey: "1",
	    testvalue: ''
	}
